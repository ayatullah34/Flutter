...
class _StudentAddState extends State with StudentValidationMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Öğrenci bilgi güncelleme"),
        ),
        body: Container(
  ...
  Widget buildFirstNameField() {
    return TextFormField(
      ...
      decoration: InputDecoration(labelText: "Öğreci adı",hintText: "Exp:Ali"),
  ...
  Widget buildLastNameField() {
    return TextFormField(
      ...
      decoration: InputDecoration(labelText: "Öğreci soyadı",hintText: "Exp:Göz"),
  ...
  Widget buildGradeField() {
    return TextFormField(
      ...
      decoration: InputDecoration(labelText: "Öğreci notu",hintText: "Exp:55"),
